...
### 결과물 형식은 다음 중에서 한가지 방식으로 제출 (프로젝트 기술서 + zip파일)

- 구글 코랩이나 주피터 노트북으로 프로젝트를 진행한 경우는, 작업한 ipynb들을 묶어서 zip으로 제출
- Streamlit 이나 Gradio로 UI도 개발한 경우는, 관련 파일도 함께 zip으로 제출
- 기타 다른 방식 개발도 가능하며 zip으로 제출

### 진행 

1. 아이디에이션, 데이터 서칭 및 수집 
2. 프로젝트 기획 발표 (화요일 오후) : 해당 AI개발 배경, 해당 AI가 적용되었거나 적용될만한 기존 서비스 분석, 차별성 도출 ( 총 3~4장으로 발표 진행 )
3. 데이터 가공과 분석 진행
4. AI 개발 및 검증
5. 프로젝트 기술서 작성 및 발표 (금요일 오후) : 기획, 데이터 분석 방법, 인공지능 개발 과정, 동작 시연 화면, 발생한 문제와 해결사례

**(프로젝트 기술서는, 구글슬라이드로 작성햐여 url링크로 발표한 후, 제출할때는 ppt로 다운로드 하여 제출합니다.)**
